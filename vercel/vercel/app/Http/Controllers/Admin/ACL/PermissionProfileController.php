...
{
    protected $repository, $profile, $permission;
    ...
    public function attachPermissionProfile(Request $request, $idProfile)
    {
        ...
        return redirect()->route('profiles.permissions', $profile->id)->with('messageSuccess', 'Vinculado com sucesso');
    }
    ...
    public function detachPermissionProfile($idProfile, $idPermission)
    {
        ...
        return redirect()->route('profiles.permissions', $profile->id)->with('messageSuccess', 'Desvinculado com sucesso');
    }
}
