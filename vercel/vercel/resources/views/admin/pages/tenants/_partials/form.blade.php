...
<div class="form-group">
    ...
    <select name="active" class="form-control">
        <option value="1" @if (isset($tenant) && $tenant->active == '1') selected @endif>Ativa</option>
        <option value="0" @if (isset($tenant) && $tenant->active == '0') selected @endif>Inativa</option>
    </select>
</div>
<hr>
<h3>Assinatura</h3>
